...
var wasmBinaryFile;
  wasmBinaryFile = 'FacturaPVPC.wasm';
...
var ASM_CONSTS = {
  120668: ($0, $1) => { return Emval.toHandle(document.getElementById(Module.UTF8ToString($0, $1))); },  
 120749: ($0, $1) => { alert(Module.UTF8ToString($0, $1)); },  
 120789: () => { FS.syncfs(function (err) { if (err != null) console.error(err); }); },  
 120857: ($0, $1, $2) => { var folder = Module.UTF8ToString($0, $1); FS.mkdir(folder); FS.mount(IDBFS, {}, folder); FS.syncfs(true, function (err) { if (err != null) console.error(err); else wasmTable.get($2)(); }); }
};
